...
import com.sergi.nestedrecyclersample.databinding.ViewVerticalMovieBinding
...
class MoviesVerticalAdapter(private val listener: (Movie) -> Unit) :
    RecyclerView.Adapter<MoviesVerticalAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = parent.inflate(R.layout.view_vertical_movie, false)
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val binding = ViewVerticalMovieBinding.bind(view)
